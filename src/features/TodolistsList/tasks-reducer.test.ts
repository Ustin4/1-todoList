...
test("status of specified task should be changed", () => {
  const action = tasksActions.updateTask("2", { status: TaskStatuses.New }, "todolistId2")
...
test("title of specified task should be changed", () => {
  const action = tasksActions.updateTask("2", { title: "yogurt" }, "todolistId2")
...
test("new array should be added when new todolist is added", () => {
  const action = todoAction.addTodolist({
    todolist: {
      id: "blabla",
      title: "new todolist",
      order: 0,
...
test("propertry with todolistId should be deleted", () => {
  const action = todoAction.removeTodolist({ id: "todolistId2" })
...
test("empty arrays should be added when we set todolists", () => {
  const action = todoAction.setTodolists({
    todolists: [
